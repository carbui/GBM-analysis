...
my_color <- scale_colour_gradientn(colours = myPalette(100), limits=c(0, 0.05)) #set the limits for the pvalue colors
```
...
## Filtering with stricter parameters
```{r}
...
pc_markers_oudenardeen  <- c("Nodal", "Kcnj8", "Ggt1", "Abcc9", "Plxdc1", "Slc16a12", "Slc6a20a", "Higd1b", "Egflam", "Arhgap42", "Lin7a", "S1pr3", "Ecm2", "Gpc3", "Pth1r", "Nr1h3", "Ndufa4l2", "Pdgfrb", "Cox4i2", "Ggt5", "Gper1", "Tmem45a", "Enpep", "Ifitm1", "Cd248", "Cthrc1", "Itga4", "Lamc1", "Ace2", "Mir143hg", "Eva1b", "Mylip", "Rgs5", "Myo1b", "Colec12",  "Tfpi", "Heyl", "Odf3l1", "Cald1", "Slc38a11","Gjc1", "Kcne4", "Plce1", "Lama2", "Vasn", "Lhfp", "Ednra", "Nid1", "Gja4", "F2r", "Sept11", "Sik1", "Notch3", "Pten", "Eps8", "Aspn", "Phldb2", "Cyth3", "Lamc3", "Mrc2","Tenc1", "Pear1")
pc_markers_oudenardeen   <- lapply(pc_markers_oudenardeen , toupper)
pc_markers_oudenardeen  <- as.character(pc_markers_oudenardeen)

DotPlot(seurat.int, features = pc_markers_oudenardeen, assay = "RNA") + RotatedAxis() + sc_dotplot
DotPlot(merged_seurat_filtered, features = pc_markers_oudenardeen) + RotatedAxis() + sc_dotplot
```
